...
//assign wd_cnt = ram_wc_cnt;

assign wd_cnt =  { {CNT_WIDTH-(LOG_DEPTH+1) {1'b0}}, tok_count_o };

assign ram_wr_ena = wr_addr_enable;
assign ram_rd_ena = rd_addr_enable;
