...
// Altera Simple Dual-Port memory template

`timescale 1 ps / 1 ps

module zcsl_ram_1r1w
#(
	parameter DW = 1,
	parameter AW = 1
)
(
	input clk,
	input wr_ena,
	input [0:AW-1] wr_addr,
	input [0:DW-1] wr_data,
	input [0:AW-1] rd_addr,
	output reg [0:DW-1] rd_data
);

// Declare the RAM variable
reg [0:DW-1] ram[0:2**AW-1];
...
always@(posedge(clk)) begin
	...
	rd_data <= ram[rd_addr]; // Returns OLD data
	//rd_data = ram[rd_addr]; // Returns NEW data (may require bypass logic)	
end
